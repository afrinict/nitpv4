...
// Add user to session
export function loginUser(req, userId, user) {
...
export function generateMembershipId(type) {
    const prefix = 'TP-A';
...
export function calculateSubscriptionFee(membershipType) {
...
export function calculateApplicationFee(applicationType, applicantType) {
    const adminFee = 5200;
...
export async function verifyActiveSubscription(userId) {
    try {
...
export function creditsToNaira(credits) {
    // 1 Naira = 6 Credits
    return credits / 6;
}
