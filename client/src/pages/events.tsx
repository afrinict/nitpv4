...
const Events = () => {
  ...
  const events = [
    ...
    },
    {
      ...
      description: 'A hands-on workshop focusing on sustainable urban development practices.',
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <header className="bg-white dark:bg-gray-800 shadow-md">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="flex items-center space-x-6">
            ...
            <Link href="/about" className="text-gray-600 dark:text-gray-300 hover:text-blue-700 dark:hover:text-blue-400 font-medium">
              About Us
            </Link>
            <Link href="/events" className="text-blue-700 dark:text-blue-400 font-medium">
              Events
            </Link>
      ...
      <main className="container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-8">Upcoming Events</h1>
          ...
          {events.map((event) => (
            <div key={event.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <button className="mt-6 w-full bg-blue-700 text-white py-2 px-4 rounded-md hover:bg-blue-800 transition-colors duration-300">
                  Register Now
                </button>
              </div>
            </div>
